...
const skillsData: Skill[] = [
  ...
  { id: 's4', name: 'Figma', level: 92, category: 'Software' },
  ...
  { id: 'dp4', name: 'User Experience (UX)', level: 85, category: 'Design Principles' },
  ...
  // Other (Soft Skills)
  { id: 'o1', name: 'Project Management', level: 85, category: 'Other' },
  { id: 'o2', name: 'Client Communication', level: 95, category: 'Other' },
  { id: 'o3', name: 'Creative Problem Solving', level: 92, category: 'Other' },
];
